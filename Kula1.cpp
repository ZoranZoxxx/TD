...
Kula1::Kula1(int id, QGraphicsItem *roditelj)
    : Kula(id) /* MZ*/{
    this->id = id;
...
int Kula1::identifikacijaKula(){
    return 1;
}

int Kula1::getPrecnikDometa()
{
    return PRECNIK_KRUGA_DOMETA;

}

int Kula1::getPolovinaSirine()
{
    return POLOVINA_SIRINE_KULE;
}

QGraphicsEllipseItem *Kula1::getDomet()
{
    return domet;
}

void Kula1::mousePressEvent(QGraphicsSceneMouseEvent *event){
...
void Kula1::mouseReleaseEvent(QGraphicsSceneMouseEvent *event){
